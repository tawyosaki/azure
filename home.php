...
<div id="Layer4" class="boxrounded2">
  ...
  <form id="form1" name="form1" method="post" action="">
    <div align="center">
      <input type="image" name="imageField" src="12.gif" />
    </div>
  </form>
</div>
<div id="Layer6">
  <table width="284" border="0" class="boxrounded12">
    ...
    <tr>
      <td height="50" bordercolor="#333333" bgcolor="#333333"><div align="left"><span class="style21"><span class="style28"><a href="<?php echo $logoutAction ?>"></a></span></span></div></td>
...
<div class="boxrounded12" id="Layer8">
  ...
  <ul><li class="style54"><a href="cat/catat.php">Create new diary</a></li>
    ...
    <li class="style54"><a href="akun/hapus.php">Delete Account </a></li>
